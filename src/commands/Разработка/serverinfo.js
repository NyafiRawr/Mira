...
module.exports = {
  ...
  execute(message /* , args, CooldownReset */) {
    ...
    const verificationLevel = require('../../data/verificationLevel.json')[message.guild.verificationLevel];
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField(`Роли (${message.guild.roles.size - 1})`, message.guild.roles.map((r) => r.toString().trim()).slice(1, 24).join(' ') || 'Нет', false)
