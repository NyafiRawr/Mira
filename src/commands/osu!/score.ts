...
module.exports = {
  ...
  async execute(message: Discord.Message, args: string[]) {
    ...
    .setDescription(
      ...
      + ` ${modePick === 3 ? `[${beatmap.diff_size}K]` : ''}`
    ...
    .addField('Результат',
      ...
      + `\n**${(modePick === 3 && score.perfect === '1') ? 'Фулл-комбо' : 'Комбо'}:**`
      + ` ${tools.separateThousandth(score.maxcombo)} / ${tools.separateThousandth(beatmap.max_combo)}`
