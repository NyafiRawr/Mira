        ...
        switch (args.shift()) {
            ...
            case 'yes': {
                ...
                if (gildId != undefined) {
                    ...
                    if (gild == null) {
                        throw new Error(
                            'к сожалению, эта гильдия уже была распущена.'
                        );
                    }
                    ...
                    message.reply(
                        'у тебя нет приглашения, чтобы принимать его.'
                    );
                }
                return;
            }
            case 'no': {
                if (gilds.invites.has(message.author.id)) {
                    ...
                    message.reply(
                        'у тебя нет приглашения, чтобы отклонять его.'
                    );
                }
                return;
            }
                            ...
                            },
                            {
                                ...
                                value:
                                    ...
                                    `\n\`${
                                        ...
                                        (
                                            await gilds.priceBuyChannelText(
                                                message.guild!.id
                                            )
                                        ).toString()
                                    )}:cookie:` +
                                    `\n\`${
                                        ...
                                        (
                                            await gilds.priceBuyChannelVoice(
                                                message.guild!.id
                                            )
                                        ).toString()
                                    )}:cookie:` +
